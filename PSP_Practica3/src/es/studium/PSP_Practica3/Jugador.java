...
public class Jugador extends JFrame implements ActionListener{
	...
	public Jugador(Socket socket, String nombre)
	{
		...
		super("Conexión del jugad@r: " + nombre);
		setLayout(null);
		...
		try
		{
			...
			String texto = "> " + nombre + " entra en el juego.";
	...
	// El método main es el que lanza el cliente, para ello, en primer lugar, se solicita el nombre o nick del cliente,
	// una vez especificado el nombre se crea la conexión al servidor y se crea la pantalla del Chat(ClientChta) lanzando
	// su ejecución (ejecutar()).
	public static void main(String[] args) throws Exception
	{
		...
		{
			Jugador cliente = new Jugador(socket, nombre);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		// Si se pulsa el botón Salir se envía un mensaje indicando que el cliente abandona el chat y también se envía un * para indicar al servidor que el cliente se ha cerrado
		else if(e.getSource() == desconectar)
		{
			String texto = "> " + nombre + " abandona el juego...";
			try
			{
				fsalida.writeUTF(texto);
				fsalida.writeUTF("*");
	...
	// Esto se ejecutta en un bucle del que solo se sale en el momento que el cliente pulse el botón Salir y se modifique la variable repetir
